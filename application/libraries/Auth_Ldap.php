...
class Auth_Ldap {
    ...
    function login($username, $password) {
        ...
        // MODIFIED by mfp215
        // If no user info is supplied from _authenticate, login failed
        if ($user_info === FALSE) {
            return FALSE;
        }
    ...
    private function _authenticate($username, $password) {
        ...
        // MODIFIED by mfp215
        // if user does not exists in the DB, create a new user
    ...
    private function _get_role($username) {
        ...
        // MODIFIED by mfp215
        // Lehigh doesn't supply roles, so if the user isnt in the database,
        // set role to 1. otherwise, get their role from the database
